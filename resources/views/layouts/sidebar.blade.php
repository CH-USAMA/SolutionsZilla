        ...
        @if(Auth::user()->isSuperAdmin())
            <div class="pt-3 mt-3 border-t border-gray-100">
                ...
                <a href="{{ route('super-admin.users.index') }}"
                    class="flex items-center gap-2.5 px-3 py-2 mt-1 rounded-lg transition-all duration-150 {{ request()->routeIs('super-admin.users.*') ? 'bg-indigo-50 text-indigo-700 font-semibold' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z">
                        </path>
                ...
                <a href="{{ route('super-admin.roles.index') }}"
                    class="flex items-center gap-2.5 px-3 py-2 mt-1 rounded-lg transition-all duration-150 {{ request()->routeIs('super-admin.roles.*') ? 'bg-indigo-50 text-indigo-700 font-semibold' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
