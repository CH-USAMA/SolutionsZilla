        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm border border-gray-100 rounded-2xl overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-100 bg-gray-50/30">
                    ...
                    <p class="text-xs text-gray-500 mt-0.5">Configure login credentials and system access.</p>
                </div>

                <form action="{{ route('super-admin.users.store') }}" method="POST" class="p-6 space-y-5">
                    @csrf
