        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm border border-gray-100 rounded-xl overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
                    <h2 class="text-lg font-bold text-gray-900">New Account</h2>
                    <p class="text-xs text-gray-500 mt-1">Create a login account for front-desk staff.</p>
                </div>

                <form action="{{ route('staff.store') }}" method="POST" class="p-6 space-y-6">
                    @csrf

                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase tracking-widest mb-1">Full Name
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase tracking-widest mb-1">Phone
                            Number</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-bold text-gray-700 uppercase tracking-widest mb-1">Password
                                <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-700 uppercase tracking-widest mb-1">Confirm
